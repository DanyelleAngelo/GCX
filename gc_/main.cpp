...
int main(int argc, char *argv[]) {
    ...
    char *reportFile = (op != "-e" && argc >=5) ? argv[5] : (op == "-e" && argc >=6 ) ? argv[6] : nullptr;
    char *queriesFile = (op == "-e" && argc >=6) ? argv[5] : nullptr; 

    grammar(argv[2], argv[3], reportFile, queriesFile, op, coverage);
